...
//* now we will do unit testing, unit test case we will write, let us go to some page and lets see whether the page is loaded or not lets see whether a component is loaded or not , may be lets take an example of contact us page , if I click on this contact page lets see whether the contact page is loaded or not , its a very basic component , let us check this so basically this is a very basic component  I want to test this contact component.
//
